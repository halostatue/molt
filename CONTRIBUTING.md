...
Contribution to `molt` is encouraged: bug reports, discussions,
...
`molt` contributions must be well understood by the submitter and
...
`molt` has adopted a variation of the Conventional Commits format
