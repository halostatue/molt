...
`molt` is copyright © 2026 Austin Ziegler and is licensed under the
[Apache License, version 2.0](licences/APACHE-2.0.txt).

The TOML test fixtures in `test/toml-fixtures` are from
[`toml-lang/toml-test`][toml-test] and are copyright the TOML authors under the
[MIT](licences/MIT.txt) licence.
...
[toml-test]: https://github.com/toml-lang/toml-test.git
